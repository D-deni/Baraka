...
import ImgLeft from '/img/elements/feedback/left.png?url'
import ImgRight from '/img/elements/feedback/right.png?url'
import IconPensive from '/img/elements/feedback/pensive.png?url'
import IconRolling from '/img/elements/feedback/rolling.png?url'
import IconKiss from '/img/elements/feedback/kiss.png?url'
import IconHeart from '/img/elements/feedback/heart-eyes.png?url'
import ImgStick from '/img/elements/feedback/thanks/stick.png?url'
import ImgStar from '/img/elements/feedback/thanks/star.png?url'
import {ref} from "vue";
